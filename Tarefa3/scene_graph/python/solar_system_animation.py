# python/solar_system_animation.py
...
class SolarSystemAnimation(Engine):
    ...
    def Update(self, time): # O método na sua engine base parece ser Update com U maiúsculo
        # Limpa as transformações anteriores para aplicar as novas
        ...
        # Velocidades angulares (em radianos por segundo)
        earth_orbit_speed = 0.5
        moon_orbit_speed = 3.0
        earth_spin_speed = 2.0
        sun_spin_speed = 0.2

        # Calcula os novos ângulos em radianos
        ...
        # ATENÇÃO: Converte para graus e chama o método .Rotate()
        # O método Rotate da sua biblioteca espera o ângulo em GRAUS
